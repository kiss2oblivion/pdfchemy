...
| **Vanguard Zero-Trust Shield** | `MainActivity.kt`, `PdfEditorScreen.kt`, `ReflowReaderScreen.kt` | `PdfSanitizerEngine.hasExecutableThreats` | ✅ Live | Pre-flight zero-trust gatekeeper: immediately blocks opening of PDFs containing embedded JavaScript, /Launch actions, /OpenAction, /AA auto-run hooks, or attachments |
