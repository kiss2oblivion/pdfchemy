...
package shrinkpdf.desktop.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/shrinkpdf.desktop.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/shrinkpdf.desktop.generated.resources/" + path)
